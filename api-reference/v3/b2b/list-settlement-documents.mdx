...
Uploading is not filing. The `refs` array on the [submit](/api-reference/v3/b2b/submit-settlement) is the whole set — a document you do not name there is deactivated and stops being listed. After a submit, this list is exactly what you filed.
