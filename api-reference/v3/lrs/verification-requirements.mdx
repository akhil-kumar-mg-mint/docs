...
<Info>
  **The services row has its own page.** Its full response, the nine fields it asks for and why it collects no identity document are on [Get Verification Requirements — B2B Services](/api-reference/v3/b2b/verification-requirements).
</Info>
