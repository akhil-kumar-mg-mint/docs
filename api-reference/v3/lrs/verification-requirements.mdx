...
This is the pull equivalent of the [`LRS_VERIFICATION_NEEDED`](/api-reference/v3/webhooks/lrs-verification-needed) webhook. Both return the same requirement block, built by the same code, so you can render your collection form from either.
