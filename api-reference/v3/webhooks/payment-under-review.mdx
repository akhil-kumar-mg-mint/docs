...
| [`LRS_VERIFICATION_NEEDED`](/api-reference/v3/webhooks/lrs-verification-needed) | Entry objects, plus `action_required_documents` | Something is owed on an LRS payment. |
