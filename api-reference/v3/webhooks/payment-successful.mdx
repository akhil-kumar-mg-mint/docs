...
4. **Note:** You may subsequently receive a **VERIFICATION_NEEDED** webhook if verification details are missing on the order (see [Verification Needed](/api-reference/v3/webhooks/verification-needed)). LRS payments receive [**LRS_VERIFICATION_NEEDED**](/api-reference/v3/webhooks/lrs-verification-needed) instead.
