...
```json Education, with travel leg (S0305)
{
  ...
  "data": {
    ...
    "action_required_fields": [
      ...
      {
        "field": "declaration_resident_in_india",
        "label": "Declaration: the remitter is a person resident in India",
        "reason": "REQUIRED",
        "message": "Required for this purpose code.",
        "waivable": false
      },
      {
        "field": "declaration_lrs",
        "label": "Declaration: the remittance is within the remitter's LRS limit",
        "reason": "REQUIRED",
        "message": "Required for this purpose code.",
        "waivable": false
      },
      {
        "field": "declaration_source_of_funds",
        "label": "Declaration: the funds are the remitter's own",
        "reason": "REQUIRED",
        "message": "Required for this purpose code.",
        "waivable": false
      },
      {
        "field": "principal",
        "label": "Remitted principal for this payment, in INR",
        "reason": "REQUIRED",
        "message": "Required for this purpose code.",
        "waivable": false
      },
      {
        "field": "collected_tcs",
        "label": "TCS collected from the payer, in INR — cross-checked against the figure we compute",
        "reason": "REQUIRED",
        "message": "Required for this purpose code.",
        "waivable": false
      },
...
```json Education, fees only (S1107)
{
  ...
  "data": {
    ...
    "submit": {
      "method": "POST",
      "path": "/pg/lrs/payments/PR8125440971/verification/"
    }
  }
}
```
...
```json Travel - medical (S0304)
{
  ...
  "data": {
    ...
    "submit": {
      "method": "POST",
      "path": "/pg/lrs/payments/PR2288140537/verification/"
    }
  }
}
```
...
```json Travel - pilgrimage (S0303)
{
  ...
  "data": {
    ...
    "submit": {
      "method": "POST",
      "path": "/pg/lrs/payments/PR9317025648/verification/"
    }
  }
}
```
