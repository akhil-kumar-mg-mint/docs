...
3. **A verification submit was refused** on a payment with no LRS checklist. The event names what to fix.
...
<CardGroup cols={2}>
  ...
  <Card title="Upload Payment Verification Details" icon="pen-to-square" href="/api-reference/v3/payment/upload-verification-details">
