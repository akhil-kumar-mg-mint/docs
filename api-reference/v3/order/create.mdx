...
| Name | Type | Required | Description | Constraints |
|---|---|---|---|---|
| bank_name | string | Yes | Name of the customer's bank. | Must be one of the supported bank names — see [Supported Banks](/integration-guide/v3/web-integration/s2s-netbanking#supported-banks) |
...
- **Supported Banks**: See the [full list of supported banks](/integration-guide/v3/web-integration/s2s-netbanking#supported-banks)
