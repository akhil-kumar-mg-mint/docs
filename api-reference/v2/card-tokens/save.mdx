...
- Support for multiple card types (Credit Card, Debit Card)
...
- [List Saved Cards](/api-reference/v2/card-tokens/list) - Retrieve saved cards for a customer
- [Delete Saved Card](/api-reference/v2/card-tokens/delete) - Remove a saved card
- [Create Order](/api-reference/v2/order/create) - Use saved cards in orders