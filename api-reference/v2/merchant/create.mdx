...
### Required Parameters
- `email`: Contact email for the sub-merchant
- `phone_number`: Contact phone with country code (E.164 format)
- `company_details`: Company registration and business information
...
| company_details | object | Yes | Company registration and business details. | See Company Details |
...
| category | string | Yes | Description of the business vertical. | Max 255 chars |
...
```json E-commerce (B2C, US)
{
  ...
  "company_details": {
    ...
    "business_mode": "b2c",
    "category": "Online Retail and Subscription Commerce",
...
| ERR_MERCHANT_002 | Merchant not found | Parent merchant account not found |
| 40188 | Invalid country name | Country name does not match any known country |
