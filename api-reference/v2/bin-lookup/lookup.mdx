---
title: 'BIN Lookup'
description: 'Look up card network, type, bank, and issuance information from BIN (Bank Identification Number).'
openapi: 'POST /pg/bin/'
---
...
This endpoint helps you provide a better user experience by pre-validating card information and displaying appropriate payment options.
...
- **UI Enhancement**: Show the card network logo or bank name as the user types
