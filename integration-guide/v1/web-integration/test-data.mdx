...
<Warning>
  These test card, UPI, and wallet credentials must only be used in the sandbox environment. Using these test cards in the production environment may cause validation errors.
</Warning>

<Tip>
  Any value can be used for the name parameter in the test environment.
</Tip>
...
You can use **anything@payu** or **9999999999@payu** as VPA to test your UPI-related integration in the sandbox (Test environment). For subscription testing, you can use **9999999999@upi**.
