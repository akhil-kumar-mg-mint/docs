...
<Note>
  For detailed parameters and response formats, see the [Get Order API](https://docs.eximpe.com/api-reference/v1/order/get)
</Note>
...
For more information, see the [Payment Successful response](https://docs.eximpe.com/api-reference/v1/webhooks/payment-successful)
