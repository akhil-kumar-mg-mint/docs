...
2. **Manual Save (Dedicated API)**: Call the [Save Card API](/api-reference/card-tokens/save) to tokenize card details independently of a payment.
...
Use the dedicated [Save Card API](/api-reference/card-tokens/save) to tokenize cards manually:
