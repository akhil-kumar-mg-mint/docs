...
<Card title="📚 API Reference" href="/api-reference/v1/order/create">
...
<Card title="📚 API Reference" href="/api-reference/v1/order/get-status">
...
- `mop_type`: Method of payment (UPI, DEBIT_CARD, etc.)
...
<CardGroup cols={2}>
  ...
  <Card title="Additional Security">
    EximPe recommends implementing transaction details APIs and webhooks/callbacks as an extra security measure. For more information, refer to the [Get Order Status API](/api-reference/v1/order/get-status) and Webhooks documentation.
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="book-open"
    href="/api-reference/v1/order/create"
  >
