...
For the full request and response schema, see the [**Create Card Subscription**](https://docs.eximpe.com/api-reference/v1/subscriptions/create-card) endpoint in the API Reference.
