...
<CardGroup cols={2}>
  ...
  <Card title="No User Dependency" icon="user-check">
    Works even if the customer closes the browser or loses connection
  </Card>
...
<Note>
  **Next Steps:**
  - Review the [API Reference](/api-reference/v1/webhooks) for detailed webhook payload specifications
