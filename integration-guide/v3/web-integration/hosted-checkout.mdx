...
<Card title="📚 API Reference" href="/api-reference/v3/order/create">
...
<Card title="📚 API Reference" href="/api-reference/v3/order/get-status">
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="book-open"
    href="/api-reference/v3/order/create"
  >
