...
<Card title="📚 API Reference" href="/api-reference/v3/payment-link/create">
...
<Card title="📚 API Reference" href="/api-reference/v3/payment-link/retrieve">
...
- **[List Links](/api-reference/v3/payment-link/list)**: View all your generated payment links.
- **[Retrieve Link](/api-reference/v3/payment-link/retrieve)**: Get details of a specific payment link.
- **[Deactivate Link](/api-reference/v3/payment-link/deactivate)**: Cancel a link before it expires.
