...
description: "Check mandate status, let recurring payments run, modify or cancel a mandate, trigger ad hoc charges, and read payment history."
---
...
<CardGroup cols={3}>
  ...
  <Card title="Ad Hoc Payment" icon="credit-card" href="#trigger-an-adhoc-recurring-payment">
