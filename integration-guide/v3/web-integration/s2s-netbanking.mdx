...
- [Payment Successful](/api-reference/v3/webhooks/payment-successful)
- [Payment Failed](/api-reference/v3/webhooks/payment-failed)

## Supported Banks

Pass the **Bank Name** value in `netbanking_details.bank_name` when initiating the payment.

| Bank Name | Payment Method Code |
|-----------|---------------------|
| Axis Bank | NB_AXIS |
| Bank of India | NB_BOI |
| Bank of Maharashtra | NB_BOM |
| Central Bank Of India | NB_CBI |
| Corporation Bank | NB_CORP |
| Development Credit Bank | NB_DCB |
| Federal Bank | NB_FED |
| HDFC Bank | NB_HDFC |
| ICICI Netbanking | NB_ICICI |
| Industrial Development Bank of India | NB_IDBI |
| Indian Bank | NB_INDB |
| IndusInd Bank | NB_INDUS |
| Indian Overseas Bank | NB_IOB |
| Jammu and Kashmir Bank | NB_JNK |
| Karnataka Bank | NB_KARN |
| Karur Vysya | NB_KVB |
| State Bank of Bikaner and Jaipur | NB_SBBJ |
| State Bank of Hyderabad | NB_SBH |
| State Bank of India | NB_SBI |
| State Bank of Mysore | NB_SBM |
| State Bank of Travancore | NB_SBT |
| South Indian Bank | NB_SOIB |
| Union Bank of India | NB_UBI |
| United Bank Of India | NB_UNIB |
| Vijaya Bank | NB_VJYB |
| Yes Bank | NB_YESB |
| CityUnion | NB_CUB |
| Canara Bank | NB_CANR |
| State Bank of Patiala | NB_SBP |
| Citi Bank NetBanking | NB_CITI |
| Deutsche Bank | NB_DEUT |
| Kotak Bank | NB_KOTAK |
| Dhanalaxmi Bank | NB_DLS |
| ING Vysya Bank | NB_ING |
| Andhra Bank | NB_ANDHRA |
| Punjab National Bank CORPORATE | NB_PNBCORP |
| Punjab National Bank | NB_PNB |
| Bank of Baroda | NB_BOB |
| Catholic Syrian Bank | NB_CSB |
| Oriental Bank Of Commerce | NB_OBC |
| Standard Chartered Bank | NB_SCB |
| Tamilnad Mercantile Bank | NB_TMB |
| Saraswat Bank | NB_SARASB |
| Syndicate Bank | NB_SYNB |
| UCO Bank | NB_UCOB |
| Bank of Baroda Corporate | NB_BOBCORP |
| Allahabad Bank | NB_ALLB |
| Bank of Bahrain and Kuwait | NB_BBKM |
| Janata Sahakari Bank | NB_JSB |
| Lakshmi Vilas Bank Corporate | NB_LVBCORP |
| Lakshmi Vilas Bank Retail | NB_LVB |
| North Kanara GSB | NB_NKGSB |
| Punjab and Maharashtra Coop Bank | NB_PMCB |
| Punjab and Sind Bank | NB_PNJSB |
| Ratnakar Bank | NB_RATN |
| Royal Bank of Scotland | NB_RBS |
| Shamrao Vithal Coop Bank | NB_SVCB |
| Tamil Nadu State Apex Coop Bank | NB_TNSC |
| DENA Bank | NB_DENA |
| COSMOS Bank | NB_COSMOS |
| DBS Bank Ltd | NB_DBS |
| DCB BANK Business | NB_DCBB |
| SVC Cooperative Bank | NB_SVC |
| Bharat Bank | NB_BHARAT |
| Karur Vysya Corporate Banking | NB_KVBCORP |
| Union Bank Corporate Banking | NB_UBICORP |
| IDFC Bank | NB_IDFC |
| The Nainital Bank | NB_NAIB |
| Airtel Payments Bank | NB_AIRTEL |
...
For additional support, see the [API Reference](/api-reference/v3/) or contact our integration team.
