...
<CardGroup cols={2}>
  <Card title="Merchant Approved" icon="user-check">
    **When:** A sub-merchant is approved<br/>
  ...
  <Card title="Payment Settled" icon="money-bill">
    **When:** Funds are settled to the beneficiary<br/>
    **Use Case:** Update accounting and reconciliation records
  </Card>
  <Card title="Payment Refunded" icon="rotate-left">
    **When:** A refund is processed<br/>
    **Use Case:** Update your ledger, notify the buyer
  </Card>
  <Card title="Refund / Dispute Updates" icon="scale-balanced">
    **When:** A refund status changes or a dispute is updated<br/>
...
<Note>
  **Next Steps:**
  - Review the [API Reference](/api-reference/v3/webhooks) for detailed webhook payload specifications
