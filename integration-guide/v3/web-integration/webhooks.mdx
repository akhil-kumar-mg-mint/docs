...
| **Verification Needed** | A non-LRS payment needs details, or its verification becomes `IN_REVIEW` or `EXPIRED` | Fix what `action_required_fields` names, or record the outcome |
