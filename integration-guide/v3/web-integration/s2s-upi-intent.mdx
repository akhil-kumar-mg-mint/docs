...
For **LRS education** payments, that is the same four-call flow used for virtual account collections — verify the remitter's PAN, quote the TCS, upload the supporting documents, and submit the remitter, purpose, and declarations.
