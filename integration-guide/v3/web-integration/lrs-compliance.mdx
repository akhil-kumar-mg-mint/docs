...
These map onto the `declarations` object and the `tcs_threshold_breached` flag on [Submit Verification Details](/api-reference/v3/lrs/submit-verification-details):
