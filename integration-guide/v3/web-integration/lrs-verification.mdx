...
Every settlement blocker below comes from doing one of these out of order. The two that cost the most are quoting before the PAN is verified, and asking the buyer for the amount to be settled instead of the amount to be collected.
...
flowchart TD
    ...
    C --> D["Ask for the <b>amount to be collected</b><br/>total_payable_inr<br/>amount to be settled + fee + GST + TCS"]
