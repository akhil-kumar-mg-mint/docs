...
| Field | Value | Where you read it |
| :--- | :--- | :--- |
| `verification.status` | `under_review` | The response to a submit call |
| `verification_status` | `IN_REVIEW` | The webhook |

Same state — accepted by EximPe, now with the bank. Different field, different casing. Match on the field, not the word.
