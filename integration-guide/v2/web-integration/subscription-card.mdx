...
For the full request and response schema, see the [**Create Card Subscription**](https://docs.eximpe.com/api-reference/v2/subscriptions/create-card-flow) endpoint in the API Reference.
