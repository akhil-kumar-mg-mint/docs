...
- **[List Saved Cards](/api-reference/v2/card-tokens/list)**: Retrieve customer's saved cards
- **[Delete Saved Card](/api-reference/v2/card-tokens/delete)**: Remove saved card tokens
...
For additional support, consult our [API Reference](/api-reference/v2/) or contact our integration team. 