...
<Card title="📚 API Reference" href="/api-reference/v2/order/create">
...
<Steps>
  <Step title="Include JS SDK">
    ...
    ```html
    <script
      src="https://cdn.eximpe.com/sdk/eximpe-sdk-1.1.0.min.js"
      integrity="sha384-5AHrZ8dfzODTyNdEelwQMZGQ//sTsYhkvFcBLN/gNacHKOREiQn2J7RM31qh4B6C"
...
<Card title="📚 API Reference" href="/api-reference/v2/order/get-status">
...
When EximPe redirects to your `return_url`, it sends payment details via a POST request. You must verify the authenticity of this callback using the hash value provided.
...
- `mop_type`: Method of payment (UPI, CREDIT_CARD, etc.)
...
<CardGroup cols={2}>
  ...
  <Card title="Additional Security">
    EximPe recommends implementing transaction details APIs and webhooks/callbacks as an extra security measure. For more information, refer to the [Get Order Status API](/api-reference/v2/order/get-status) and Webhooks documentation.
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="book-open"
    href="/api-reference/v2/order/create"
  >
