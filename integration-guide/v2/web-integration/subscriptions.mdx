...
<CardGroup cols={5}>
  ...
  <Card title="View Payments" icon="list" href="#step-4-view-subscription-payments">
    Fetch all payments associated with a subscription
  </Card>
  <Card title="Sandbox Testing" icon="flask" href="#step-5-sandbox-testing">
...
The integration consists of five steps:

1. **Create Subscription**
2. **Check Mandate Status**
3. **Modify or Cancel Mandate**
4. **View Subscription Payments**
5. **Sandbox Testing**
...
## Step 4: View Subscription Payments
