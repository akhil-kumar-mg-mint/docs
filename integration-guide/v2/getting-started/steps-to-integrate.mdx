...
description: "Follow these steps to register and collect payments from customers in India"
---

## Register for EximPe Account

In order to collect Payments from Indian Buyers as a foreign merchant or PA collecting payments on behalf of your merchants, first you need to [Register](/integration-guide/v2/getting-started/register-merchant) on EximPe to get your API Access key and token.

To start development, you can sign up for [Merchant Sandbox](https://merchant-uat.eximpe.com/). Please select **PSP** or **Merchant** based on your business requirement while creating the account.
